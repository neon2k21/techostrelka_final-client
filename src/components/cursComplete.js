...
export default function Curs({ postData }) {
    ...
    return (
        <View style={styles.card}>
            {/* Изображение курса */}
            <Image
                source={{ uri: `${ip_address}/${postData.preview}` }} // Предполагается, что course_preview — это путь к изображению
                style={styles.image}
            />
            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.textContent}>
                    {/* Название курса */}
                    <Text style={styles.courseName}>{postData.name}</Text>

                    {/* Топик курса */}
                    <Text style={styles.topicName}>{course.topic_name}</Text>
                </View>
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        {/* Изображение курса */}
                        <Image
                            source={{ uri: `${ip_address}/${postData.preview}` }}
                        ...
                        >
                            <Text style={styles.goButtonText}>Закрыть</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
...
const styles = StyleSheet.create({
    card: {
        ...
        shadowRadius: 5,
        elevation: 3,
        height:heightPercentageToDP(29.5)
    },
    image: {
        width: '100%',
        height: 200,
